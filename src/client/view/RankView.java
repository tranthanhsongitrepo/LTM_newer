...
public class RankView extends javax.swing.JFrame {
    ...
    public void addExitButtonListener(java.awt.event.ActionListener actionListener) {
        jButton1.addActionListener(actionListener);
    }

    public void updateTable(ArrayList<BangXepHang> objects) {
        ((DefaultTableModel) jTable1.getModel()).setRowCount(objects.size());
        for (int i = 0; i < objects.size(); i++) {
            ...
            t = (float) objects.get(i).getTongSoNuocDiTranThua() / objects.get(i).getSoTranThua();
            jTable1.setValueAt(objects.get(i).getSoTranThua() == 0 ? 0 : t, i, 5);
